...
let flag = sessionStorage.getItem("Curusername");
if (flag) {
    sign.innerHTML = '<li id="Already_Sign_In">你好!' + decodeURIComponent(sessionStorage.getItem("Curusername")) + '<a id="Exit">退出登录</a></li>';
